...
/**
 * Parses a date into both its local and UTC equivalent, in mysqli datetime format.
 *
 * @since 4.4.0
 *
 * @see rest_parse_date()
 ...
 * @return array|null Local and UTC datetime strings, in mysqli datetime format (Y-m-d H:i:s),
 *                    null on failure.
 */
